...
export default function RootLayout({ children }) {
  return (
    <html lang="en" className="light" style={{ overflowX: 'clip' }}>
      ...
      <body className="text-on-background font-body-md w-full max-w-[100vw] selection:bg-primary-container selection:text-on-background cursor-none" style={{ overflowX: 'clip' }}>
