...
const newHero = `export default function Hero() {
  ...
  return (
    <div ref={heroRef} className="w-full flex flex-col bg-background relative overflow-hidden">
      ...
      {/* --- SECTION 1: INTRO --- */}
      <section className="relative min-h-[100dvh] w-full flex flex-col justify-center px-margin-mobile md:px-margin-desktop py-24">
        {/* Background Elements */}
        <div 
      ...
      <section className="relative w-full flex flex-col justify-start items-center text-left pt-12 md:pt-24 px-margin-mobile md:px-margin-desktop pb-32 z-20">
        <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
          <div 
            className="absolute inset-0 opacity-30 transition-transform duration-[400ms] md:duration-200 ease-out"
            style={{ transform: \`translate3d(calc(var(--mx, 0) * -2px), calc(var(--my, 0) * -2px), 0)\` }}
          >
          ...
          <div 
            ...
            style={{ transform: \`translate3d(calc(var(--mx, 0) * -7px), calc(var(--my, 0) * -7px), 0)\` }}
          >
        ...
        <div className="relative z-20 w-full max-w-6xl mx-auto transition-transform duration-200 ease-out"
          ...
          <div className="w-full h-auto min-h-[1100px] md:min-h-[850px] max-w-6xl mx-auto relative mt-8 pb-8">
            <svg className="absolute inset-0 w-full h-full pointer-events-none z-0" viewBox="0 0 100 100" preserveAspectRatio="none">
              ...
              <path 
                ...
                vectorEffect="non-scaling-stroke" 
                pathLength="100"
                className="drop-shadow-[0_0_8px_var(--color-cobalt)] opacity-80"
              />
            </svg>
...
console.log("Successfully replaced Hero.jsx!");
